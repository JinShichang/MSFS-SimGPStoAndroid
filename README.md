...
> 把微软模拟飞行（MSFS 2020 / 2024）中飞机的实时位置，模拟到安卓手机的系统定位上，让你可以使用第三方地图进行导航，现实中的 EFB 软件理论上也兼容。
...
- 📍 **模拟定位**：通过 Android 模拟位置提供者（GPS + 网络双通道）注入位置，支持最多 3 台手机同时连接
...
- 🎮 **等待游戏启动**：游戏未启动时电脑端窗口照常显示二维码，手机可以先连接，游戏启动后自动推送数据
